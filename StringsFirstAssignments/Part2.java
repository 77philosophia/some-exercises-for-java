...
public class Part2 {
    ...
    public String findSimpleGene(String s,String startCodon,String stopCodon){
        ...
        String start_upper = startCodon.toUpperCase();
        String stop_upper = stopCodon.toUpperCase();
        int startIndex = s_upper.indexOf(start_upper);
        if(startIndex == -1)
            return "";
        int endIndex = s_upper.indexOf(stop_upper,startIndex+3);
        if(endIndex == -1)
            return "";
    ...
    public void testSimpleGene(){
        ...
        String resultDNA1 = findSimpleGene(dna1,"atg","taa");
